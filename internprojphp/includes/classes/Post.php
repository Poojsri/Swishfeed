...
class Post{
    ...
    public function loadPostsFriends($data,$limit){
        ...
        if(mysqli_num_rows($data_query)>0){
            $num_iterations = 0; // num of iterations
            $count=0;
            while($row = mysqli_fetch_array($data_query)){
                ...
                //check if the user posted,has their account closed
                ...
                if($user_logged_obj->isFriend($added_by)){
                    ...
                    if($interval->y==1){
                        ...
                        if($interval->d ==1){
                            $time_messageys = $interval->d . "yesterday";
                        }else{
                            $time_message = $interval->d . "dayss ago";
                        }
                    ...
                    $str .= "<div class='status_post' onClick='javascript:toggle$id()'>
                        ...
                        <div class='posted_by' style='color:#ACACAC;'>
                            <a href='$added_by' style='text-decoration:none;'>
